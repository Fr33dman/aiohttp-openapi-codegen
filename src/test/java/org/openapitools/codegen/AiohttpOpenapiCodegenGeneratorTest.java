 ...
 * 1) Set a break point in AiohttpOpenapiCodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class AiohttpOpenapiCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("aiohttp-openapi-codegen") // use this codegen library
              ...
              .setOutputDir("out/aiohttp-openapi-codegen"); // output directory
